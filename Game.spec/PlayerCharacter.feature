Feature: PlayerCharacter
	...
	As a human player
	I want my character attribute to be correctly represeneted
...
@elf
Scenario: Elf race characters get additional 20 damage resistance with table
...
Scenario: Rading a restore health scroll when over tired has no effect
